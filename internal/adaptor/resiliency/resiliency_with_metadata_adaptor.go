...
func (a *ResiliencyAdaptor) UnaryResiliencyWithMetadata(ctx context.Context, minDelaySecond int32,
...
func (a *ResiliencyAdaptor) ServerStreamingResiliencyWithMetadata(ctx context.Context, minDelaySecond int32,
...
func (a *ResiliencyAdaptor) ClientStreamingResiliencyWithMetadata(ctx context.Context, minDelaySecond int32,
...
func (a *ResiliencyAdaptor) BiDirectionalResiliencyWithMetadata(ctx context.Context, minDelaySecond int32,
	maxDelaySecond int32, statusCodes []uint32, count int) {
